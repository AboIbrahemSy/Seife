<x-guest-layout>
    ...
    <div class="container mx-auto my-24">
        ...
        <div
            class="max-w-sm p-6 mx-auto border shadow-xl bg-gradient-to-br from-stone-50 to-stone-200 rounded-xl border-stone-200">
            <!-- Header with stars -->
            ...
            <p class="mb-6 text-sm font-medium leading-relaxed text-stone-600">
                "The platform has revolutionized how we handle customer interactions. Incredibly intuitive and
                powerful!"
            </p>
            ...
            <div class="flex items-center gap-3">
                <div class="relative">
                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&auto=format&fit=crop&w=150&q=80"
                        alt="alex johnson" class="object-cover w-10 h-10 rounded-full ring-2 ring-white" />
                    <div class="absolute w-4 h-4 bg-green-400 border-2 border-white rounded-full -bottom-1 -right-1">
                    </div>
                </div>
                <div class="flex-1">
